...
<div class="modal fade" id="servicios<?php echo $row_huespedes['id_bed_booking'];?>" tabindex="-1" role="dialog" aria-hidden="true" data-keyboard="false" data-backdrop="static">
...
$my_booking_p = $row_huespedes['id_bed_booking'];
...
$my_booking_ppp = $row_huespedes['id_bed_booking'];
...
<?php } while ($row_usuarios_services_listos_ppp = mysqli_fetch_assoc($query_services_listos_ppp)); ?>
      ...
      <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">Cancel</button>
        ...
        <button type="submit" name="save_services_admin" class="btn btn-info" value="<?php echo $row_huespedes['id_bed_booking'];?>">
