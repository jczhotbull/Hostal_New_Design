...
<div class="modal fade" id="payme_edit_last<?php echo $id_pay;?>" tabindex="-1" role="dialog" aria-hidden="true">
...
<input type="date"  class="form-control" id="tercer_pago_fecha" name="tercer_pago_fecha"  aria-label="tercer_pago_fecha" aria-describedby="basic-addon1" required> 
...
<span class="input-group-text alert-success" id="basic-addon1"><i class="fa-solid fa-money-check-dollar fa-lg"></i></span>  
                                        ...
                                        <select class="form-control " id="id_tercer_pago_forma" name="id_tercer_pago_forma" required>
...
<input type="text" maxlength="29" class="form-control " id="tercer_pago_recibo" name="tercer_pago_recibo" aria-label="tercer_pago_recibo" aria-describedby="basic-addon1" placeholder="Transaction N°" required>
