...
<div class="modal fade" id="borrar_passport_per<?php echo $row_usuarios['id_guests']; ?>" tabindex="-1" role="dialog" aria-hidden="true" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php echo $row_usuarios['guests_doc_id'];?>, <?php echo $row_usuarios['p_name_g'];?> <b>Doc "Pic"</b> will be deleted. 
      </div>
  ...
  <form method="post" name="delete_pic_per"> 
    ...
    <button type="submit" name="borrarXX_passport_per" id="borrarXX_passport_per" class="btn btn-danger" >
