...
<div class="modal fade" id="borrar_pic_per<?php echo $row_usuarios['id_per']; ?>"
...
<?php echo $row_usuarios['p_surname_per'];?>, <?php echo $row_usuarios['p_name_per'];?> <b>Pic</b> will be deleted. 
...
<button type="submit" class="ms-2 btn btn-outline-danger" name="borrarXX_pic_per" id="borrarXX_pic_per"><i class="far fa-trash-alt fa-lg"></i></button>
